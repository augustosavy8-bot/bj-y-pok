...
const img = (name: string) =>
  `<img src="/slots/olympus/${name}.png" alt="" loading="lazy" style="width:100%;height:100%;object-fit:contain;filter:drop-shadow(0 2px 4px rgba(0,0,0,.55))">`;
...
export const olympus: SlotTheme = {
  ...
  scene:
    ...
    "url('/slots/olympus/fondo.jpg') center 20%/cover no-repeat",
  logo: "/slots/olympus/logo.png",
